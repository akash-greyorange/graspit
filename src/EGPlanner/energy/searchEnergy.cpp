...
#define HAND_POSE_ROLL_FILTER_UPPER_1                         (1.3)        /* 60 degrees cone up and down */
#define HAND_POSE_ROLL_FILTER_UPPER_2                         (1.9)

#define HAND_POSE_ROLL_FILTER_LOWER_1                         (-1.3)       /* 60 degrees cone up and down */
#define HAND_POSE_ROLL_FILTER_LOWER_2                         (-1.9)          
